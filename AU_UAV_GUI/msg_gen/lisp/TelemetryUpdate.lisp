...
(cl:defmethod cl:initialize-instance :after ((m <TelemetryUpdate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TelemetryUpdate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name AU_UAV_GUI-msg:<TelemetryUpdate> is deprecated: use AU_UAV_GUI-msg:TelemetryUpdate instead.")))

(cl:ensure-generic-function 'telemetryHeader-val :lambda-list '(m))
(cl:defmethod telemetryHeader-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:telemetryHeader-val is deprecated.  Use AU_UAV_GUI-msg:telemetryHeader instead.")
  (telemetryHeader m))

(cl:ensure-generic-function 'planeID-val :lambda-list '(m))
(cl:defmethod planeID-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:planeID-val is deprecated.  Use AU_UAV_GUI-msg:planeID instead.")
  (planeID m))

(cl:ensure-generic-function 'currentLatitude-val :lambda-list '(m))
(cl:defmethod currentLatitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:currentLatitude-val is deprecated.  Use AU_UAV_GUI-msg:currentLatitude instead.")
  (currentLatitude m))

(cl:ensure-generic-function 'currentLongitude-val :lambda-list '(m))
(cl:defmethod currentLongitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:currentLongitude-val is deprecated.  Use AU_UAV_GUI-msg:currentLongitude instead.")
  (currentLongitude m))

(cl:ensure-generic-function 'currentAltitude-val :lambda-list '(m))
(cl:defmethod currentAltitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:currentAltitude-val is deprecated.  Use AU_UAV_GUI-msg:currentAltitude instead.")
  (currentAltitude m))

(cl:ensure-generic-function 'destLatitude-val :lambda-list '(m))
(cl:defmethod destLatitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:destLatitude-val is deprecated.  Use AU_UAV_GUI-msg:destLatitude instead.")
  (destLatitude m))

(cl:ensure-generic-function 'destLongitude-val :lambda-list '(m))
(cl:defmethod destLongitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:destLongitude-val is deprecated.  Use AU_UAV_GUI-msg:destLongitude instead.")
  (destLongitude m))

(cl:ensure-generic-function 'destAltitude-val :lambda-list '(m))
(cl:defmethod destAltitude-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:destAltitude-val is deprecated.  Use AU_UAV_GUI-msg:destAltitude instead.")
  (destAltitude m))

(cl:ensure-generic-function 'groundSpeed-val :lambda-list '(m))
(cl:defmethod groundSpeed-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:groundSpeed-val is deprecated.  Use AU_UAV_GUI-msg:groundSpeed instead.")
  (groundSpeed m))

(cl:ensure-generic-function 'targetBearing-val :lambda-list '(m))
(cl:defmethod targetBearing-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:targetBearing-val is deprecated.  Use AU_UAV_GUI-msg:targetBearing instead.")
  (targetBearing m))

(cl:ensure-generic-function 'currentWaypointIndex-val :lambda-list '(m))
(cl:defmethod currentWaypointIndex-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:currentWaypointIndex-val is deprecated.  Use AU_UAV_GUI-msg:currentWaypointIndex instead.")
...
(cl:defmethod distanceToDestination-val ((m <TelemetryUpdate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader AU_UAV_GUI-msg:distanceToDestination-val is deprecated.  Use AU_UAV_GUI-msg:distanceToDestination instead.")
