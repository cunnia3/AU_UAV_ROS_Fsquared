/* Auto-generated by genmsg_cpp for file /home/viki/ros_workspace/Google_Maps_CMAKE/msg/TelemetryUpdate.msg */
#ifndef GOOGLE_MAPS_CMAKE_MESSAGE_TELEMETRYUPDATE_H
#define GOOGLE_MAPS_CMAKE_MESSAGE_TELEMETRYUPDATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TelemetryUpdate_ {
  ...
  typedef boost::shared_ptr< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct TelemetryUpdate
typedef  ::Google_Maps_CMAKE::TelemetryUpdate_<std::allocator<void> > TelemetryUpdate;

typedef boost::shared_ptr< ::Google_Maps_CMAKE::TelemetryUpdate> TelemetryUpdatePtr;
typedef boost::shared_ptr< ::Google_Maps_CMAKE::TelemetryUpdate const> TelemetryUpdateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "53cd950963d7a5c403c785f8c0a2ffa7";
  }

  static const char* value(const  ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x53cd950963d7a5c4ULL;
  static const uint64_t static_value2 = 0x03c785f8c0a2ffa7ULL;
};

template<class ContainerAllocator>
struct DataType< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "Google_Maps_CMAKE/TelemetryUpdate";
  }
...
template<class ContainerAllocator>
struct Definition< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::Google_Maps_CMAKE::TelemetryUpdate_<ContainerAllocator> & v) 
  {
...
#endif // GOOGLE_MAPS_CMAKE_MESSAGE_TELEMETRYUPDATE_H
