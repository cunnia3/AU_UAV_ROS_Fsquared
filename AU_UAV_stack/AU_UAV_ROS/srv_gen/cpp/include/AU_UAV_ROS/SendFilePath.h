/* Auto-generated by genmsg_cpp for file /home/viki/ros_workspace/AU_UAV_stack/AU_UAV_ROS/srv/SendFilePath.srv */
#ifndef AU_UAV_ROS_SERVICE_SENDFILEPATH_H
#define AU_UAV_ROS_SERVICE_SENDFILEPATH_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
{
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_ROS::SendFilePathRequest_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_ROS::SendFilePathRequest_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
namespace message_traits
{
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_ROS::SendFilePathResponse_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::AU_UAV_ROS::SendFilePathResponse_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
{
template<>
struct MD5Sum<AU_UAV_ROS::SendFilePath> {
  static const char* value() 
  {
    return "fe8131f61ada79495e0d839037fe5bd9";
  }

  static const char* value(const AU_UAV_ROS::SendFilePath&) { return value(); } 
};

template<>
struct DataType<AU_UAV_ROS::SendFilePath> {
  static const char* value() 
  {
    return "AU_UAV_ROS/SendFilePath";
  }
...
#endif // AU_UAV_ROS_SERVICE_SENDFILEPATH_H
