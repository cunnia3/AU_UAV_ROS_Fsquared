...
static void mavlink_test_au_uav(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_au_uav_t packet_in = {
		963497464,
	963497672,
	963497880,
	963498088,
	...
	mavlink_au_uav_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.au_lat = packet_in.au_lat;
        	packet1.au_lng = packet_in.au_lng;
        	packet1.au_alt = packet_in.au_alt;
        	packet1.au_target_lat = packet_in.au_target_lat;
        	packet1.au_target_lng = packet_in.au_target_lng;
        	packet1.au_target_alt = packet_in.au_target_alt;
        	packet1.au_ground_speed = packet_in.au_ground_speed;
        	packet1.au_target_bearing = packet_in.au_target_bearing;
        	packet1.au_distance = packet_in.au_distance;
        	packet1.au_target_wp_index = packet_in.au_target_wp_index;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_au_uav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_pack(system_id, component_id, &msg , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_au_uav_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_au_uav_send(MAVLINK_COMM_1 , packet1.au_lat , packet1.au_lng , packet1.au_alt , packet1.au_target_lat , packet1.au_target_lng , packet1.au_target_alt , packet1.au_ground_speed , packet1.au_target_bearing , packet1.au_distance , packet1.au_target_wp_index );
	mavlink_msg_au_uav_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_au_uav(system_id, component_id, last_msg);
}
