...
(cl:in-package Google_Maps_CMAKE-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SendFilePath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendFilePath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Google_Maps_CMAKE-srv:<SendFilePath-request> is deprecated: use Google_Maps_CMAKE-srv:SendFilePath-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <SendFilePath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Google_Maps_CMAKE-srv:filename-val is deprecated.  Use Google_Maps_CMAKE-srv:filename instead.")
  (filename m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendFilePath-request>)))
  ...
  "Google_Maps_CMAKE/SendFilePathRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendFilePath-request)))
  "Returns string type for a service object of type 'SendFilePath-request"
  "Google_Maps_CMAKE/SendFilePathRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SendFilePath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SendFilePath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Google_Maps_CMAKE-srv:<SendFilePath-response> is deprecated: use Google_Maps_CMAKE-srv:SendFilePath-response instead.")))

(cl:ensure-generic-function 'error-val :lambda-list '(m))
(cl:defmethod error-val ((m <SendFilePath-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Google_Maps_CMAKE-srv:error-val is deprecated.  Use Google_Maps_CMAKE-srv:error instead.")
  (error m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SendFilePath-response>)))
  ...
  "Google_Maps_CMAKE/SendFilePathResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendFilePath-response)))
  "Returns string type for a service object of type 'SendFilePath-response"
  "Google_Maps_CMAKE/SendFilePathResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SendFilePath)))
  ...
  "Google_Maps_CMAKE/SendFilePath")