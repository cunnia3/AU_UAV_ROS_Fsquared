...
//DJ_2/17/13 added this to send our message
//this function is stored in the file: /include/mavlink/v1.0/common/mavlink_msg_au_reu_uav.h

static void NOINLINE send_au_uav(mavlink_channel_t chan)
{
...
static bool mavlink_try_send_message(mavlink_channel_t chan, enum ap_message id, uint16_t packet_drops)
{
    ...
    //DJ_2/25/2013 - added case for our message to send
    case MSG_AU_UAV:
        CHECK_PAYLOAD_SIZE(AU_UAV);
        send_au_uav(chan);
        break;
...
GCS_MAVLINK::data_stream_send(void)
{
    ...
    if (stream_trigger(STREAM_POSITION)) {
        // sent with GPS read
        //DJ_2/25/2013 - Take this out to only send our message below
        //send_message(MSG_LOCATION);
        
        //DJ_2/25/2013 - send our message here
        send_message(MSG_AU_UAV);
    }
