...
SET(MAVLINK_IncludeSearchPaths
  ...
  ${CMAKE_SOURCE_DIR}/include/mavlink
  )
...
FIND_PATH(GCS_MAVLINK_INCLUDE_DIR
  NAMES GCS_MAVLink.h
  PATHS ${MAVLINK_IncludeSearchPaths}
)

FIND_PATH(MAVLINK_COMPAT_INCLUDE_DIR
  NAMES Mavlink_compat.h
  PATHS ${MAVLINK_IncludeSearchPaths}
)
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(MAVLINK "Could NOT find MAVLink protocol (mavlink.h)"
  ...
  GCS_MAVLINK_INCLUDE_DIR
  MAVLINK_COMPAT_INCLUDE_DIR
)
