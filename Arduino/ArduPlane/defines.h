...
#define DEBUG 0
//DJ_2/25/2013 - changed loiter range from 60 to 10 to make the UAV fly through loiter WPs
#define LOITER_RANGE 10 // for calculating power outside of loiter radius
...
/// stream
//DJ_2/25/2013 - added a define for our message
enum ap_message {
    MSG_HEARTBEAT,
    MSG_AU_UAV,
    MSG_ATTITUDE,
