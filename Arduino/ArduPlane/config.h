...
//DJ_ Edit this to change the system ID of MAV - real UAVs are sysIDs 32-64
#ifndef MAV_SYSTEM_ID
 # define MAV_SYSTEM_ID          32
#endif
...
//DJ_2/25/2013 - changed default loiter radium from 60 to 10 to make UAV go through loiter waypoints
